<?php
	...
	mysqli_query($conn,"insert into product (product_name,categoryid,product_price,product_qty,photo, supplierid,camera,proccess) values ('$name','$category','$price','$qty','$location', '$supplier','$cam','$pro')");
