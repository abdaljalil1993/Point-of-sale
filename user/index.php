		...
		while($row=mysqli_fetch_array($query)){
			...
			?>
				...
				<div>
					...
					<div style="height:50px; width:230px; margin-left:17px;"><?php echo $row['product_name']; ?><br>
					...
					echo'<p style="color:red">Rate : '.$s1.'</p><br>';

				}
				else{
					echo'<p style="color:red">Rate is : 0 Now</p><br>';
				}
					?>
