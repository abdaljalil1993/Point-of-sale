<!-- Navigation -->
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                <a class="navbar-brand" href="#">WEB SEL & BUY</a>
            </div>
			...
			<ul class=" nav navbar-nav">
				...
				<li>
					...
					<div class="input-group" id="searchbox" style="width:500px;">
						...
						<a href="se.php" style="margin-left: 11px;"  class="btn btn-info"><i class="glyphicon glyphicon-search"></i>Special Search</a>
						</div>
					</div>
					</form>
				</li>
            ...
            <ul class="nav navbar-top-links navbar-right">
            	<li><a href="ratepro.php">rate products</a></li>
				<li class="dropdown">
