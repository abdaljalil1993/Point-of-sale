		...
		while($row=mysqli_fetch_array($query)){
			...
			?>
				...
				<div>
					...
					<div style="height:50px; width:230px; margin-left:17px;"><?php echo $row['product_name']; ?>
						
	<?php
						 $sum=0;
					$n=0;
					$y=mysqli_query($conn,"select * from ratepro where pid='".$row['productid']."' and pname='".$row['product_name']."'");
					...
					echo'<p style="color:orange">Rate : '.$s1.'</p><br>';

				}
				else{
					echo'<p style="color:orange">Rate is : 0 Now</p><br>';
				}
					?>
					...
					<div style="margin-left:17px; margin-right:17px;">
						...
						<a href="../rt/rc.php?id=<?php echo $row['productid']; ?>" class="btn btn-primary">Rate</a>
